...
export const PROFILE_ON_FROM_CHANGED = 'profile/on-form-changed'
...
export const RECORDS_SET_GET_RECORDS_LOADING = 'records/set-get-records-loading'
export const RECORDS_ON_RECORD_CHANGED = 'records/on-record-changed'
export const RECORDS_GET_RECORDS = 'records/get-records'
export const RECORDS_ADD_RECORD = 'records/add-record'
